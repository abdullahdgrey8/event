<div class="bg-white">
                        ...
                        <ul class=" extra-navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                ...
                                <div class="dropdown-menu dropdown-usermenu pull-right"
                                    ...
                                    <a class="dropdown-item" href="{{ route('get.destroy') }}"><i class="fa fa-sign-out pull-right"></i>
                                        Log Out</a>
                                </div>
                            </li>
                        </ul>
    ...
    <div class="tabs">
        <ul class="extra-navbar-right tab-design">
            <li class="flex gap-4">
                <img src="{{ asset('/build/images/calendar.svg') }}" alt="">
                <a href="{{ url('view-events') }}">View all events</a></li>
            <li>
            <img src="{{ asset('/build/images/export.svg') }}" alt="">
            <a href="{{ url('add-event') }}">Create an event</a></li>
        </ul>
    </div>
